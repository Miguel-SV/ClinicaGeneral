      ...
      <!-- **************** Incluir Menu Alumno *************** -->
       ...
       <div class="container white">
            ...
            <div class="container-fluid">
             <h3 class="center-align">Lista de Medicamentos</h3>
            <br>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Editar"  href="adminEditar.php?idMedicamento=<?php echo $row['idMedicamento']; ?>" ><i class="botoness2 zmdi zmdi-border-color zmdi-hc-2x "></i></a></td>
                        ...
                        parent.location = 'MedicamentoEliminar.php?idMedicamento=<?php echo $row['idMedicamento']; ?>'
                    } else {
                        ''
                    }
